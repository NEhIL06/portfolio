        ...
        {clubs.map((c, i) => (
          ...
          >
            <GlowCard className="h-full">
              <Card className="h-full border border-black/10 bg-white backdrop-blur transition-all duration-300 hover:bg-gray-50">
                <CardHeader>
                  <CardTitle className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-2">
                    <span className="text-xl font-semibold text-gray-900">{c.name}</span>
