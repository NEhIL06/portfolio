...
export function WhoAmI({
  title = "Who Am I",
  content = "I’m a born builder — I design and engineer systems that are clean, scalable, and human. I obsess over details, craft thoughtful abstractions, and ship with intent. From distributed backends to intuitive interfaces, I aim to create software that is fast, reliable, and delightful.",
}: {
  title?: string
  content?: string
}) {
