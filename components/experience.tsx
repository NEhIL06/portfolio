    ...
    return (
        <div className="mx-auto max-w-5xl px-4 sm:px-6 py-20 md:py-28 flex flex-col md:flex-row gap-12 relative items-start">
            ...
            <div className="md:w-2/3 flex flex-col gap-8 relative">
                ...
                <div className="absolute left-[19px] top-8 bottom-0 w-[2px] bg-gradient-to-b from-white via-white/20 to-transparent hidden md:block" />
                ...
                {experience.map((exp, i) => (
                    ...
                    >
                        ...
                        <div className="absolute left-[15px] top-8 h-[10px] w-[10px] rounded-full bg-white hidden md:block z-10 shadow-[0_0_10px_rgba(255,255,255,0.8)]" />
                        <div className="absolute left-[15px] top-8 h-[10px] w-[10px] rounded-full bg-white animate-[ping_3s_ease-in-out_infinite] hidden md:block z-0" />
